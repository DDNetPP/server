...
set_vars() {
	...
	export CC=clang
	export CXX=clang++
	export CXXFLAGS="-fsanitize=address,undefined,leak -fsanitize-recover=address,undefined -fno-omit-frame-pointer -rdynamic"
	export CFLAGS="-fsanitize=address,undefined,leak -fsanitize-recover=address,undefined -fno-omit-frame-pointer -rdynamic"
}
